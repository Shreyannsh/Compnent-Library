...
const Installation = () => {
  return (
    <div className="installationContainer">
      ...
      <iframe
        src="https://carbon.now.sh/embed?bg=rgba%28228%2C228%2C228%2C1%29&t=vscode&wt=none&l=javascript&width=871&ds=true&dsyoff=20px&dsblur=52px&wc=true&wa=false&pv=0px&ph=0px&ln=false&fl=1&fm=Hack&fs=14px&lh=90%25&si=false&es=2x&wm=false&code=%2520%2520%2520%2520%253Clink%2520rel%253D%2522stylesheet%2522%2520href%253D%2522https%253A%252F%252Felementhub.netlify.app%252Fstyle%252Fmain.css%2522%2520%252F%253E%250A"
        className="iframe"
      ...
      <iframe
        src="https://carbon.now.sh/embed?bg=rgba%28228%2C228%2C228%2C1%29&t=vscode&wt=none&l=javascript&width=871&ds=true&dsyoff=20px&dsblur=52px&wc=true&wa=false&pv=0px&ph=0px&ln=false&fl=1&fm=Hack&fs=13.5px&lh=90%25&si=false&es=2x&wm=false&code=%2509%2509%2509%2509%2509%2540import%2520url%28%27https%253A%252F%252Felementhub.netlify.app%252Fstyle%252Fmain.css%27%29%250A%250A"
        className="iframe"
